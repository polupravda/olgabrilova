...

{
    ...
    class Content {
        ...
        show() {
            ...
            TweenMax.staggerTo([this.DOM.backCtrl,this.DOM.title,this.DOM.subtitle,this.DOM.text,this.DOM.demo], 0.8, {
                ease: Power4.easeOut,
                delay: 0.4,
                opacity: 1,
                startAt: {y: 40},
        ...
        hide() {
            ...
            TweenMax.staggerTo([this.DOM.backCtrl,this.DOM.title,this.DOM.subtitle,this.DOM.text,this.DOM.demo].reverse(), 0.3, {
                ease: Power3.easeIn,
                opacity: 0,
                y: 10
            }, 0.01);
